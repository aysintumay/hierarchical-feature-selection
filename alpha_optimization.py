...
if __name__ == "__main__":
    ...
    plt.plot(y_test.index, mape_first_mean_expanding ,"--", color="red")
    plt.plot(y_test.index, mape_all_mean_expanding, "--", color="green")
    plt.plot(y_test.index, mape_second_mean_expanding, color="black")
    plt.plot(y_test.index, mape_ensemble_mean_expanding, "-.", color="blue")
